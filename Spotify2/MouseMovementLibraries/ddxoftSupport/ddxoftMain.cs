...
namespace Spotify2.MouseMovementLibraries.ddxoftSupport
{
    internal class DdxoftMain
    {
        ...
        public static async Task<bool> DLLLoading()
        {
            try
            {
                ...
                {
                    MessageBox.Show("The ddxoft Virtual Input Driver requires Spotify to be run as an administrator, please close Spotify and run it as administrator to use this movement method.", "Spotify");
                    return false;
                }
                ...
                {
                    MessageBox.Show("The ddxoft virtual input driver is not compatible with your PC, please try a different Mouse Movement Method.", "Spotify");
                    return false;
                }
