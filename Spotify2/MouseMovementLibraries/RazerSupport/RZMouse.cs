...
namespace Spotify2.MouseMovementLibraries.RazerSupport
{
    internal class RZMouse
    {
        ...
        public static async Task<bool> Load()
        {
            ...
            {
                MessageBox.Show("No Razer Peripheral is detected, this Mouse Movement Method is unusable.", "Spotify");
                return false;
            }
            ...
            {
                MessageBox.Show($"DLL loading error: {dllEx}\nEnsure {rzctlpath} is present and correctly loaded.", "Spotify");
                return false;
            }
            catch (Exception ex)
            {
