...
# Warning
To not get banned in some strict games, make sure you
...
## Arduino Setup 2 methods
### Arduino Setup Easy(Credit to Slow Potato for making this guide)
...
### Arduino Setup Better(Raggy method)
- This setup will be harder than the other one
- Go to https://sketcher.raggy.cc/ and follow the guide there
- Also make sure you click the box icon on the left and download the custom spoofer
- Run the custom spoofer as Admin and select whatever mouse and hit apply spoof
